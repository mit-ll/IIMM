...
from datasets.imagenet import ImageNet,ImageNetV2,ImageNetSketch,ImageNetRendition,ImageNetAdversarial
...
def get_dataset(dataset_name, preprocess, location="./data", batch_size=128, num_workers=16, val_fraction=0.1, max_val_samples=5000):
